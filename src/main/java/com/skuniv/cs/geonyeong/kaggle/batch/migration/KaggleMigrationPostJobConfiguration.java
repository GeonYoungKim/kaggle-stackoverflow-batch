...
public class KaggleMigrationPostJobConfiguration extends DefaultBatchConfigurer {
    ...
    public FlatFileItemReader<Question> questionReader() {
        ...
        reader.setLineMapper((line, lineNumber) -> {
            ...
            Question question = Question.builder()
                .id(questionSplit[0])
                .title(StringUtils.equals(EMPTY_FIELD_VALUE, questionSplit[1]) ? ""
                    : questionSplit[1])
                .body(StringUtils.equals(EMPTY_FIELD_VALUE, questionSplit[2]) ? ""
                    : questionSplit[2])
                .answerCount(StringUtils.equals(EMPTY_FIELD_VALUE, questionSplit[3]) ? 0
                    : Integer.valueOf(questionSplit[3]))
                .commentCount(StringUtils.equals(EMPTY_FIELD_VALUE, questionSplit[4]) ? 0
                    : Integer.valueOf(questionSplit[4]))
                .createDate(StringUtils.equals(EMPTY_FIELD_VALUE, questionSplit[5]) ? TimeUtil
                    .toStr(new Date()) : TimeUtil.toStr(questionSplit[5]))
                .favoriteCount(StringUtils.equals(EMPTY_FIELD_VALUE, questionSplit[6]) ? 0
                    : Integer.valueOf(questionSplit[6]))
                .score(StringUtils.equals(EMPTY_FIELD_VALUE, questionSplit[9]) ? 0
                    : Integer.valueOf(questionSplit[9]))
                .tags(StringUtils.equals(EMPTY_FIELD_VALUE, questionSplit[10]) ? ""
                    : questionSplit[10])
                .viewCount(StringUtils.equals(EMPTY_FIELD_VALUE, questionSplit[11]) ? 0
    ...
    public FlatFileItemReader<Answer> answerReader() {
        ...
        reader.setLineMapper((line, lineNumber) -> {
            ...
            Answer answer = Answer.builder()
                ...
                .commentCount(StringUtils.equals(EMPTY_FIELD_VALUE, answerSplit[2]) ? 0
                    : Integer.valueOf(answerSplit[2]))
                .createDate(StringUtils.equals(EMPTY_FIELD_VALUE, answerSplit[3]) ? TimeUtil
                    .toStr(new Date()) : TimeUtil.toStr(answerSplit[3]))
                .parentId(
                    StringUtils.equals(EMPTY_FIELD_VALUE, answerSplit[6]) ? "" : answerSplit[6])
                .score(StringUtils.equals(EMPTY_FIELD_VALUE, answerSplit[7]) ? 0
                    : Integer.valueOf(answerSplit[7]))
                .tags(
                    StringUtils.equals(EMPTY_FIELD_VALUE, answerSplit[8]) ? "" : answerSplit[8])
                .account(account)
                .commentList(commentList)
                .linkList(linkList)
                .qnaJoin(
    ...
    private Account createAccount(String id, String name, String aboutMe, String age,
