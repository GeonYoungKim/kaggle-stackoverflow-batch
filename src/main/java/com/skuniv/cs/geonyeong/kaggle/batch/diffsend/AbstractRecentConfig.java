...
public abstract class AbstractRecentConfig {
    ...
    protected AvroAccount createAvroAccount(String id, String name, String aboutMe, String age,
        ...
        return AvroAccount.newBuilder()
            ...
            .setUpvotes(
                StringUtils.equals(EMPTY_FIELD_VALUE, upVotes) ? 0 : Integer.valueOf(upVotes))
            .setDownVotes(
            ...
            .map(item -> {
                ...
                try {
                    ...
                    avroComment = AvroComment.newBuilder()
                        .setCommentId(
                            StringUtils.equals(EMPTY_FIELD_VALUE, commentDetailSplit[0]) ? ""
                                : commentDetailSplit[0])
                        .setBody(StringUtils.equals(EMPTY_FIELD_VALUE, commentDetailSplit[1]) ? ""
                            : commentDetailSplit[1])
                        .setCreateDate(
                            StringUtils.equals(EMPTY_FIELD_VALUE, commentDetailSplit[2]) ? TimeUtil
                                .toStr(new Date()) : TimeUtil.toStr(commentDetailSplit[2]))
                        .setPostId(StringUtils.equals(EMPTY_FIELD_VALUE, commentDetailSplit[3]) ? ""
                            : commentDetailSplit[3])
                        .setScore(StringUtils.equals(EMPTY_FIELD_VALUE, commentDetailSplit[6]) ? 0
                            : Integer.valueOf(commentDetailSplit[6]))
        ...
        return Arrays.stream(avroLinkSplit)
            ...
            .map(item -> {
                ...
                return AvroLink.newBuilder()
                    .setLinkId(StringUtils.equals(EMPTY_FIELD_VALUE, linkDetailSplit[0]) ? ""
                        : linkDetailSplit[0])
                    .setPostId(StringUtils.equals(EMPTY_FIELD_VALUE, linkDetailSplit[1]) ? ""
                        : linkDetailSplit[1])
                    .setRelatedPostId(StringUtils.equals(EMPTY_FIELD_VALUE, linkDetailSplit[2]) ? ""
                        : linkDetailSplit[2])
                    .build();
            })
            .collect(Collectors.toList());
